...
The dashboard now includes an Executive Summary Draft section generated from the selected budget scenario.
...
The text is deterministic and based on computed model/scenario values. It does not use generative AI.

## Phase 6 Done Criteria

Phase 6 is complete when:

- Executive summary logic is reusable and tested.
- Dashboard renders business-facing summary text.
